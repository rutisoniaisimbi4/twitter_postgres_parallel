...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/rutisoniaisimbi4/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/rutisoniaisimbi4/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/rutisoniaisimbi4/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/rutisoniaisimbi4/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/rutisoniaisimbi4/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/rutisoniaisimbi4/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | 15m1s                     | 1m28s                     | 
| `pg_normalized_batch`  | 3m9s                      | 12s                       | 
| `pg_denormalized`      | 1m36s                     | 14s                       | 
